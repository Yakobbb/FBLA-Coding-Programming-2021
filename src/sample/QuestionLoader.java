...
/*
This class is the MOAB of this program. It is responsible for generating questions, initializing the
...
public class QuestionLoader {
    ...
    NOTE: localhost:5432 is used since the server is running locally on my machine.
    Because of this, the program can only load into the main menu and help screens on other machines,
    since they don't require use of the server.
     */
    public void generateQuestion(String category) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            /*
             Makes sure no questions are repeated in current quiz
             */
